...
<div class="width70 left">
    <table class="widefat">
        ...
        <tbody>
            <tr>
                <td>
                    <ul class="sc-sortable grid" data-action="<?php echo SC_SERVICES_PATH; ?>">
                        <?php
                        $args = array(
                            'post_type' => 'service',
                        ...
                        if ($members->have_posts()) {
                                ...
                                <li id="<?php echo $id; ?>" itemscope itemtype="http://schema.org/Person" class="sc_service ui-state-default" data-order="<?php echo $order; ?>">
                                    <div class="sc_service_inner">
                                        ...
                                        <div itemprop="jobtitle" class="sc_service_jobtitle">
                                            <?php echo get_post_meta($id, 'service_cost', true); ?>
                                        </div>
                                    </div>
                                </li>
                                <?php
                            ...
                            _e('There are no services to display', 'smartcat-services');
                        }
                        ?>
                    </ul>
            </tr>
