...
class SmartcatServicesPlugin {
    ...
    public static function deactivate() {
        ...
        if( self::DEVMODE ) :
            ...
            delete_option( 'smartcat_services_options' );
...
//        add_action('admin_init', array( $this, 'smartcat_services_deactivate_license' ) );
//        add_action('admin_init', array( $this, 'smartcat_services_activate_license' ) );
//        add_action('admin_init', array( $this, 'smartcat_services_register_option' ) );
        add_filter( 'the_content', array( $this, 'smartcat_set_single_content' ) );
        
        add_filter( 'manage_edit-service_columns', array( $this, 'set_columns') );
        add_action( 'manage_service_posts_custom_column' , array( $this, 'custom_columns' ), 10, 2 );
    ...
    public function set_columns( $columns ) {
        ...
        $columns['service_icon'] = __( 'Icon' );
        $columns['service_image'] = __( 'Image' );
    ...
    public function custom_columns( $column, $post_id ){
        ...
        switch( $column ) :
            ...
            case 'service_icon' :
                echo '<i class="fa-2x ' . get_post_meta( $post_id, 'service_icon', TRUE ) . '"></i>';
                break;
    ...
    function smartcat_services_load_styles_scripts() {
        ...
        // plugin main script
        wp_enqueue_script( 'smartcat_services_carousel_script', SC_SERVICES_URL . 'inc/script/carousel.js', array( 'jquery' ), self::VERSION );
...
//        echo '<tr><td><lablel for="service_cost">Price</lablel></td>';
//        echo '<td><input type="text" value="' . get_post_meta( $post->ID, 'service_cost', true ) . '" id="service_cost" name="service_cost" placeholder="Service Cost/Price"/></td></tr>';

        echo '<tr><td><lablel for="service_email"><img src="' . SC_SERVICES_URL . 'inc/img/email.png" width="20px"/></label></td>';
        ...
        echo '<tr><td><lablel for="service_facebook"><img src="' . SC_SERVICES_URL . 'inc/img/fb.png" width="20px"/></label></td>';
        ...
        echo '<tr><td><label for="service_twitter"><img src="' . SC_SERVICES_URL . 'inc/img/twitter.png" width="20px"/></label></td>';
        ...
        echo '<tr><td><lablel for="service_linkedin"><img src="' . SC_SERVICES_URL . 'inc/img/linkedin.png" width="20px"/></label></td>';
        ...
        echo '<tr><td><lablel for="service_gplus"><img src="' . SC_SERVICES_URL . 'inc/img/google.png" width="20px"/></label></td>';
        ...
        echo '<tr><td><lablel for="service_phone"><img src="' . SC_SERVICES_URL . 'inc/img/phone.png" width="20px"/></label></td>';
        echo '<td><input type="text" value="' . get_post_meta( $post->ID, 'service_phone', true ) . '" id="service_phone" name="service_phone" placeholder="Enter Phone Number"/></td></tr>';

        echo '<tr><td><lablel for="service_download"><img src="' . SC_SERVICES_URL . 'inc/img/files-icon.png" width="20px"/></label></td>';
        echo '<td><input type="text" value="' . get_post_meta( $post->ID, 'service_download', true ) . '" id="service_download" name="service_download" placeholder="Enter download File URL ( doc, pdf, xls etc..) "/></td></tr>';
        ...
        echo '<div class="sc_options_table">'
        . '<h4>Attributes / Skills / Ratings Bars</h4>'
                . '<p>Pro version</p>';
    ...
    public function service_box_save( $post_id ) {
        ...
        if ( isset( $_REQUEST[ 'service_cost' ] ) ) {
            $facebook_url = $_POST[ 'service_cost' ];
            update_post_meta( $post_id, 'service_cost', $facebook_url );
        }

        if ( isset( $_REQUEST[ 'service_email' ] ) ) {
            $facebook_url = $_POST[ 'service_email' ];
            update_post_meta( $post_id, 'service_email', $facebook_url );
        }


        if ( isset( $_REQUEST[ 'service_facebook' ] ) ) {
            $facebook_url = $_POST[ 'service_facebook' ];
            update_post_meta( $post_id, 'service_facebook', $facebook_url );
        }

        if ( isset( $_REQUEST[ 'service_twitter' ] ) ) {
            $twitter_url = $_POST[ 'service_twitter' ];
            update_post_meta( $post_id, 'service_twitter', $twitter_url );
        }

        if ( isset( $_REQUEST[ 'service_linkedin' ] ) ) {
            $linkedin_url = $_POST[ 'service_linkedin' ];
            update_post_meta( $post_id, 'service_linkedin', $linkedin_url );
        }

        if ( isset( $_REQUEST[ 'service_gplus' ] ) ) {
            $gplus_url = $_POST[ 'service_gplus' ];
            update_post_meta( $post_id, 'service_gplus', $gplus_url );

        }
        
        if ( isset( $_REQUEST[ 'service_phone' ] ) ) {
            update_post_meta( $post_id, 'service_phone', $_POST[ 'service_phone' ] );
        }
        
        if ( isset( $_REQUEST[ 'service_download' ] ) ) {
            update_post_meta( $post_id, 'service_download', $_POST[ 'service_download' ] );
        }

//        if ( isset( $_REQUEST[ 'service_skill1' ] ) ) {
//            $skill = $_POST[ 'service_skill1' ];
//            update_post_meta( $post_id, 'service_skill1', $skill );
//        }
//
//        if ( isset( $_REQUEST[ 'service_skill_value1' ] ) ) {
//            $value = $_POST[ 'service_skill_value1' ];
//            update_post_meta( $post_id, 'service_skill_value1', $value );
//        }
//
//        if ( isset( $_REQUEST[ 'service_skill2' ] ) ) {
//            $skill = $_POST[ 'service_skill2' ];
//            update_post_meta( $post_id, 'service_skill2', $skill );
//        }
//
//        if ( isset( $_REQUEST[ 'service_skill_value2' ] ) ) {
//            $value = $_POST[ 'service_skill_value2' ];
//            update_post_meta( $post_id, 'service_skill_value2', $value );
//        }
//
//        if ( isset( $_REQUEST[ 'service_skill3' ] ) ) {
//            $skill = $_POST[ 'service_skill3' ];
//            update_post_meta( $post_id, 'service_skill3', $skill );
//        }
//
//        if ( isset( $_REQUEST[ 'service_skill_value3' ] ) ) {
//            $value = $_POST[ 'service_skill_value3' ];
//            update_post_meta( $post_id, 'service_skill_value3', $value );
//        }
//
//        if ( isset( $_REQUEST[ 'service_skill4' ] ) ) {
//            $skill = $_POST[ 'service_skill4' ];
//            update_post_meta( $post_id, 'service_skill4', $skill );
//        }
//
//        if ( isset( $_REQUEST[ 'service_skill_value4' ] ) ) {
//            $value = $_POST[ 'service_skill_value4' ];
//            update_post_meta( $post_id, 'service_skill_value4', $value );
//        }
//
//        if ( isset( $_REQUEST[ 'service_qoute' ] ) ) {
//            $value = $_POST[ 'service_qoute' ];
//            update_post_meta( $post_id, 'service_qoute', $value );
//        }
    ...
    public function sc_custom_styles() {
        ...
        <style>
            ...
            #sc_our_services.smartcat_zoomOut .sc_service .sc_service_inner{ background: #<?php echo $this->options['background_color'] ?>; }
            .sc_personal_quote span.fa-quote-left{ color: #<?php echo $this->options['main_color']; ?>; }
            #sc_our_services_lightbox .sc_our_services_lightbox{ margin-top: <?php echo $this->options['card_margin']; ?>px }
            .sc_our_services_panel{ top: <?php echo $this->options['card_margin']; ?>px }
        </style>
        <?php
    }
    ...
    public function smartcat_set_single_content( $content ) {
        ...
        if ( is_single() ) :
            if ( $post->post_type == 'service' &&
                ...
                $content .= $this->smartcat_get_social_content( $post->ID );
                $content .= '</div>';
            endif;
        else :
    ...
    public function set_social( $id ) {
        ...
        $facebook = get_post_meta( $id, 'service_facebook', true );
        $twitter = get_post_meta( $id, 'service_twitter', true );
        $linkedin = get_post_meta( $id, 'service_linkedin', true );
        $gplus = get_post_meta( $id, 'service_gplus', true );
        $email = get_post_meta( $id, 'service_email', true );
        $phone = get_post_meta( $id, 'service_phone', true );
        $download = get_post_meta( $id, 'service_download', true );
    ...
    public function get_social( $facebook, $twitter, $linkedin, $gplus, $email, $phone, $download ) {
        ...
        if ( $download != '' )
            echo '<a href="' . $download . '" target="_BLANK"><img src="' . SC_SERVICES_URL . 'inc/img/files-icon.png" class="sc-social"/></a>';
        if ( $phone != '' )
            echo '<a href="tel:' . $phone . '"><img src="' . SC_SERVICES_URL . 'inc/img/phone.png" class="sc-social"/></a>';
    }
    ...
    public function smartcat_get_social_content( $id ) {
        ...
        if ( $facebook != '' )
            $content .= '<a href="' . $facebook . '"><img src="' . SC_SERVICES_URL . 'inc/img/fb.png" class="sc-social" title="Facebook"/></a>';
        if ( $twitter != '' )
            $content .= '<a href="' . $twitter . '"><img src="' . SC_SERVICES_URL . 'inc/img/twitter.png" class="sc-social" title="Twitter"/></a>';
        if ( $linkedin != '' )
            $content .= '<a href="' . $linkedin . '"><img src="' . SC_SERVICES_URL . 'inc/img/linkedin.png" class="sc-social" title="LinkedIn"/></a>';
        if ( $gplus != '' )
            $content .= '<a href="' . $gplus . '"><img src="' . SC_SERVICES_URL . 'inc/img/google.png" class="sc-social" title="Google Plus"/></a>';
        if ( $email != '' )
            $content .= '<a href=mailto:"' . $email . '"><img src="' . SC_SERVICES_URL . 'inc/img/email.png" class="sc-social" title="Email"/></a>';
        if ( $download != '' )
            $content .= '<a href="' . $download . '" target="_BLANK"><img src="' . SC_SERVICES_URL . 'inc/img/files-icon.png" class="sc-social" title="Download"/></a>';
        if ( $phone != '' )
            $content .= '<a href="tel:' . $phone . '"><img src="' . SC_SERVICES_URL . 'inc/img/phone.png" class="sc-social" title="Phone"/></a>';
